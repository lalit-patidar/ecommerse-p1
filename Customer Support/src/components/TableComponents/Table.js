            ...
            <tbody>
                <tr>
                    <td colSpan="7">
                        ...
                        <button className="searchButton" onClick={popSearchBox}>
                            <SearchLogo />
                        </button>
                ...
                <tr>
                    ...
                    <td className="tableHeader" width="4%" />
                    <td className="tableHeader" width="4%" />
                    <td className="tableHeader" width="26%">
                        From
                    </td>
                    <td className="tableHeader" width="50%">
                        Subject
                    </td>
                    <td className="tableHeader" width="8%">
                        Date <DropDownLogo />
                    </td>
                </tr>
                {messages
                    ...
                    .map((message, index) => (
                        <tr key={index}>
                            ...
                            <td>
                                {message.flaged ? <FlagedLogo /> : <FlagLogo />}
                            </td>
                            <td>{message.important ? <AlertLogo /> : ""}</td>
                            <td>
                                {message.unreplied ? <CornerUpLeftLogo /> : ""}
                            </td>
