...
const ClaimClosed = () => {
  ...
  useEffect(() => {
    setClaimDetails({
      ...
      brief: {
        title:
          "Example of the seller's comment, example of the seller's comment, example of the seller's comment, example of the seller's comment, example of the seller's comment, example of the seller's comment, example of the seller's comment, example of the seller's comment, example of the seller's comment, example of the seller's comment.",
        descr:
