              ...
              >
                {(props) => (
                  <form onSubmit={props.handleSubmit}>
                    ...
                    <p className="mt-0">Enter the username or email address associated with your NichoShop account.</p>
                    ...
                    <div className="textField">
                      <TextField
                        ...
                        size="small"
                        className={
                          props.touched.username && props.errors.username ? "error" : ""
                        }
                    ...
                    <Link to="/user/signin" className="noBgThemeBtn mb-3 text-bold">Cancel</Link>   
                    </div>
                  </form>
                )}
              </Formik>
