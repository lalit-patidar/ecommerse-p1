                  ...
                  {["radio"].map((type) => (
                    ...
                    >
                      <Form.Check
                        ...
                        name="group1"
                        checked={isFormSelected === 1 ? true : false}
                        type={type}
                        id={`inline-${type}-1`}
                      ...
                      <Form.Check
                        ...
                        name="group1"
                        type={type}
                        checked={isFormSelected === 0 ? true : false}
                        id={`inline-${type}-2`}
                  ...
                  <>
                    <Form onSubmit={formHandler}>
                      ...
                      <div className="ui-pwd-strength">
                        {getTotalLength === 0 ? (
                          ...
                          <>
                            ...
                            {getTotalLength <= 5 && getTotalLength > 2 && (
                              <>
                                <p>Medium</p>
                              </>
                            )}
                      ...
                      <ul className="ui-form-pwd-notify">
                        {!getPwdLength && <li>At least 8 characters.</li>}
                        {!getNumOrSimble && (
                          <li>
                        ...
                        <li>
                          Avoid using the same passwort for miltiple sites.
                        </li>
                      </ul>
