  ...
  return (
    <>
      <div className="main-overview-list">
        ...
        <Tab.Container id="left-tabs-example" defaultActiveKey="listing">
          <div className="row holder">
            <div className="col-3 padding_right_spacing text-center">
              <Nav variant="pills" className="flex-column nav-tabs w-100">
                <Nav.Item>
                ...
                <Nav.Item>
                  <Nav.Link eventKey="labels">Shipping labels</Nav.Link>
                </Nav.Item>
                <hr></hr>
                <Nav.Item>
            ...
            <div className="col-9 cols_holder">
              <Tab.Content>
                ...
                <Tab.Pane eventKey="orders">
                  <div className="container">This is orders Content</div>
                </Tab.Pane>
                <Tab.Pane eventKey="labels">
                  <div className="container">This is labels Content</div>
                </Tab.Pane>
                <Tab.Pane eventKey="settings">
                  <div className="container">This is settings Content</div>
                </Tab.Pane>
                <Tab.Pane eventKey="performance">
                  <div className="container">This is performance Content</div>
                </Tab.Pane>
              </Tab.Content>
            </div>
          </div>
