...
class Watchlist extends Component {
    ...
    productName(props){
        return (<div className='test'>
            ...
            <div><span className="text-black-50">Condition:</span> <span className="font-weight-medium">New</span></div>
            <div><span className="text-black-50">Size:</span> <span className="font-weight-medium">X</span>, <span className="text-black-50">Color:</span> <span className="font-weight-medium">Blue</span></div>
            <div><span className="text-black-50">Offered by:</span> <a className="e-link font-weight-medium" href="">seller_username</a></div>
        </div>);
    }    
    priceSection(props){
        return (<div className='pricesection'>
            <div className="main-price text-end mb-3"><span className="h4">US $ 1,234.56</span> <span className="text-black-50 d-block">Buy it now</span></div>
            <div className="price-remaining text-end mb-3"><span className="small-text18 text-black-50">+ US $ 123.45</span> <span className="text-black-50 d-block">shipping</span></div>            
        </div>);
    }
    buttonSection(props){
        return (<div className='buttonsection text-end'>
            <div className="d-grid gap-2 justify-content-md-end">                
                <a className="view-seller-items btn btn-primary" htef="">Buy it Now</a>
            </div>
            ...
            <a className="remove-items text-danger small-text18" htef=""><i class="bi bi-trash"></i> Remove</a>
        </div>);
    }      
    render(){
                        ...
                        <div className="border rounded">
                            <div className="p-3 border-bottom d-flex justify-content-end">
                                <div className="dropdown small-text18 d-flex pe-4">
                                    ...
                                    <div className="dropdown-toggle font-weight-semibold" type="button" id="total-records" data-bs-toggle="dropdown" aria-expanded="false">All(10)</div>
                                    <ul className="dropdown-menu dropdown-result-end" aria-labelledby="total-records">
                                            <li><a className="dropdown-item" href="#">All(10)</a></li>
                                ...
                                <div className="dropdown small-text18 d-flex">
                                    ...
                                    <div className="dropdown-toggle font-weight-semibold" type="button" id="total-records" data-bs-toggle="dropdown" aria-expanded="false">Time left: ending soon</div>
                                    <ul className="dropdown-menu dropdown-result-end" aria-labelledby="total-records">
                                            <li><a className="dropdown-item" href="#">Time left: ending soon</a></li>
                                    </ul>
                                </div>
                            </div>
