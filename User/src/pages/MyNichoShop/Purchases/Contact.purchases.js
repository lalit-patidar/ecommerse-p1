            ...
            <Box sx={{width: "100%", p: 2}}>
                <Box sx={{display: "flex"}} >
                    ...
                    <Grid item xs={9} spacing={2}>
                        <Typography gutterBottom variant="h6" component="div" color={blue[500]} sx={{fontSize : "20px", mt: 2}}>
            ...
            <Box sx={{width: "50%"}}>
                <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                    <Form.Select >
                        ...
                        <option>I received item that wasn’t as described</option>
                ...
                <Form.Label style={{borderBottom: "1px dotted grey", fontSize: "10px", width : "100%"}}>Accepted file formats: .gif, .jpg, .jpeg, .pdf, .and .png. Add up to 10 files, 5MB each</Form.Label>
                <Grid container spacing={2}>
                    <Grid item xs={6}>
                        <Button variant="contained" style={{width: "100%"}}>Send Message</Button>
                    </Grid>
                    <Grid item xs={6}>
