                ...
                <div className='row col-lg-4 col-md-6 col-sm-10 offset-lg-4 offset-md-3 offset-sm-1'>
                    <div className='form-layout-signinpage px-4 py-1'>
                        <form>
                            ...
                            <div>
                                <input type="password" name='password' placeholder='Password' onChange={inputValue} className='form-control mt-3' />
                            </div>
                            ...
                            <Link to='/temporary' className='text-primary mb-3 text-signinpage' >Text a temporary password</Link>
                            </div>
                        </form>
                    </div>
                </div>
